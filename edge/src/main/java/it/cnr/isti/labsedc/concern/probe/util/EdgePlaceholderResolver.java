...
/**
 * Risolve placeholder ${...} nelle stringhe template del YAML della probe.
 * Logica identica a PlaceholderResolver.java del runtime completo.
 */
public class EdgePlaceholderResolver {

    private static final Pattern PH = Pattern.compile("\\$\\{([^}]+)\\}");

    private final Map<String, Object> payload;

    public EdgePlaceholderResolver(Map<String, Object> payload) {
