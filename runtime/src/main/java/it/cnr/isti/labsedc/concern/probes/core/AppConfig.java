...
public class AppConfig {
    ...
    /**
     * Percorso del fat-jar del mini-runtime edge (concern-probe-edge.jar).
     * Usato da ProbeExportController per includerlo nello ZIP generato.
     * Override via env var EDGE_JAR_PATH.
     */
    public String edgeJarPath = "concern-probe-edge.jar";
}
